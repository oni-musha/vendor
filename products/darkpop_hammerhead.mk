...
PRODUCT_NAME := darkpop_hammerhead
PRODUCT_BRAND := Google
PRODUCT_MODEL := Nexus 5
PRODUCT_MANUFACTURER := LGE
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME="hammerhead" BUILD_FINGERPRINT="google/hammerhead/hammerhead:5.1.1/LYZ28K/2168912:user/release-keys" PRIVATE_BUILD_DESC="hammerhead-user 5.1.1 LYZ28K 2168912 release-keys"
# Kernel inline build
